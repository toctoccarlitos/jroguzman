		...
		if (plugins.rdMailForm.length) {
			var i, j, k,
				msg = {
					...
					'MF001': 'No existe destinatario!',
					'MF002': 'El formulario no funcionará localmente!',
					'MF003': 'Por favor, ingrese un email!',
					'MF004': 'Por favor, ingrese el tipo de formulario!',
					'MF254': 'Hubo algun problema!',
					'MF255': 'Recorcholis! Algo salió mal. Vuelve a intentarlo o escribe un email.'
				};
